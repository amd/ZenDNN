...
int main(int argc, char **argv) {
    ...
    try {
        ...
        file.open(zenDnnRootPath + std::string("/_out/tests/zendnn_avx_conv_param_output_direct"));
        ...
        string str = std::string("sha1sum ") + zenDnnRootPath +
            std::string("/_out/tests/zendnn_avx_conv_param_output_direct > ") + zenDnnRootPath +
        ...
        ifstream zenDnnSha1(zenDnnRootPath + std::string("/_out/tests/zendnn_avx_conv_param_output_direct.sha1"));
        string firstWordZen;
