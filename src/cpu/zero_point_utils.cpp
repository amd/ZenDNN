...
zero_point_config_t::zero_point_config_t(const primitive_attr_t &attr)
    : src_exists(!attr.zero_points_.has_default_values(ZENDNN_ARG_SRC))
    , dst_exists(!attr.zero_points_.has_default_values(ZENDNN_ARG_DST))
    , src_is_common(attr.zero_points_.common(ZENDNN_ARG_SRC)) {}
