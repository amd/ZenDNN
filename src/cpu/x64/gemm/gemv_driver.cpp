...
static inline void gemv_threading_driver(const int trans, const dim_t m,
    ...
    bool is_syncable = zendnn_thr_syncable();
    ...
    auto nthr_spawn = zendnn_thr_syncable() ? nthr_max : nthr_goal;
    int nbufs_used = 0;
...
template <>
zendnn_status_t jump_to_gemv(const gemm_info_t<int8_t, uint8_t, int32_t> *arg) {
    return zendnn_unimplemented;
}

template <>
zendnn_status_t jump_to_gemv(const gemm_info_t<int8_t, int8_t, int32_t> *arg) {
    return zendnn_unimplemented;
}

template <typename a_t, typename b_t, typename c_t>
zendnn_status_t jump_to_gemv(const gemm_info_t<a_t, b_t, c_t> *arg) {
