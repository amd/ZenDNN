...
status_t init_ip_conf_bwd_w(jit_brgemm_primitive_conf_t &jbgp) {
    ...
    jbgp.ic_block_ext = (jbgp.wei_dt == zendnn::impl::data_type::bf16) ? 32 : 16;
...
void init_scratchpad(memory_tracking::registrar_t &scratchpad,
    ...
    if (jbgp.use_buffer) {
        ...
        if (jbgp.prop_kind == zendnn_backward_weights
        ...
        } else if (jbgp.prop_kind == zendnn_backward_weights
                && jbgp.nthr_mb == 1) {
            nelements = (size_t)jbgp.nthr * jbgp.nb_ic_blocking * jbgp.ic_block
                    * jbgp.nb_oc_blocking * jbgp.oc_block;
        } else if (jbgp.prop_kind == zendnn_backward_data && jbgp.nthr_oc_b > 1) {
    ...
    if (jbgp.use_buffer_a && jbgp.prop_kind == zendnn_backward_weights) {
    ...
    } else if (jbgp.use_buffer_a && jbgp.prop_kind == zendnn_backward_data) {
        scratchpad.book(key_brgemm_primitive_buffer_a,
    ...
    if (jbgp.use_buffer_b && jbgp.prop_kind == zendnn_backward_weights) {
        int os_chunks
                = div_up(div_up(jbgp.nb_os, jbgp.nb_os_blocking), jbgp.nthr_mb);
    ...
    if (jbgp.use_buffer_b && jbgp.prop_kind == zendnn_backward_data) {
    ...
    if (jbgp.prop_kind == zendnn_backward_weights && jbgp.with_bias
    ...
    if (zendnn_thr_syncable() && jbgp.prop_kind == zendnn_backward_weights)
