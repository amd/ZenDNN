...
#ifndef ZENDNN_LPGEMM_CONVOLUTION_HPP
#define ZENDNN_LPGEMM_CONVOLUTION_HPP
...
struct zendnn_lpgemm_convolution_fwd_t : public primitive_t {
    struct pd_t : public cpu_convolution_fwd_pd_t {
        ...
        DECLARE_COMMON_PD_T("zendnn", zendnn_lpgemm_convolution_fwd_t);
    ...
    zendnn_lpgemm_convolution_fwd_t(const pd_t *apd) : primitive_t(apd) {}
