...
jit_uni_lrn_kernel_t<Derived<isa, d_type>>::jit_uni_lrn_kernel_t(
    ...
    , emulate_bfloat_(isa == avx512_common
              && d_type == zendnn::impl::data_type::bf16
...
void jit_uni_lrn_kernel_t<jit_uni_lrn_fwd_kernel_t<avx512_common,
        zendnn::impl::data_type::bf16>>::load_data(const Vmm &reg,
...
template <>
void jit_uni_lrn_kernel_t<jit_uni_lrn_fwd_kernel_t<avx512_common,
        zendnn::impl::data_type::bf16>>::store_data(const Xbyak::Address &addr,
        const Zmm &zr) {
...
void jit_uni_lrn_kernel_t<jit_uni_lrn_fwd_kernel_t<sse41,
        zendnn::impl::data_type::f32>>::load_constant(float constant,
...
template <>
void jit_uni_lrn_fwd_kernel_t<sse41, zendnn::impl::data_type::f32>::within_body(
...
template <>
jit_uni_lrn_fwd_kernel_t<sse41, zendnn::impl::data_type::f32>::
...
template <>
void jit_uni_lrn_fwd_kernel_t<sse41, zendnn::impl::data_type::f32>::generate(
...
template <>
void jit_uni_lrn_fwd_kernel_t<sse41, zendnn::impl::data_type::f32>::nchw_body(
...
void jit_uni_lrn_fwd_kernel_t<sse41,
        zendnn::impl::data_type::f32>::nchw_tail_sse41(int tail,
        Xbyak::Reg64 reg_dst, Xbyak::Xmm xtail_lo, Xbyak::Xmm xtail_hi) {
...
template <>
void jit_uni_lrn_fwd_kernel_t<sse41,
        zendnn::impl::data_type::f32>::nchw_body_sse41(int tail, int HW,
...
void jit_uni_lrn_bwd_kernel_t<isa, d_type>::within_body(int hoff, int Hoff,
    ...
    for (int i = hoff; i <= Hoff; ++i) {
        for (int j = woff; j <= Woff; ++j) {
            ...
            if (i == 0 && j == 0) {
                if (d_type == zendnn::impl::data_type::bf16) {
...
template class jit_uni_lrn_fwd_kernel_t<sse41, zendnn::impl::data_type::f32>;
template class jit_uni_lrn_fwd_kernel_t<avx2, zendnn::impl::data_type::f32>;
template class jit_uni_lrn_fwd_kernel_t<avx512_common,
        zendnn::impl::data_type::f32>;
template class jit_uni_lrn_fwd_kernel_t<avx512_common,
        zendnn::impl::data_type::bf16>;

template class jit_uni_lrn_kernel_t<
        jit_uni_lrn_fwd_kernel_t<sse41, zendnn::impl::data_type::f32>>;
template class jit_uni_lrn_kernel_t<
        jit_uni_lrn_fwd_kernel_t<avx2, zendnn::impl::data_type::f32>>;
template class jit_uni_lrn_kernel_t<
        jit_uni_lrn_fwd_kernel_t<avx512_common, zendnn::impl::data_type::f32>>;
template class jit_uni_lrn_kernel_t<
        jit_uni_lrn_fwd_kernel_t<avx512_common, zendnn::impl::data_type::bf16>>;

template class jit_uni_lrn_bwd_kernel_t<avx512_common,
        zendnn::impl::data_type::f32>;
template class jit_uni_lrn_bwd_kernel_t<avx512_common,
        zendnn::impl::data_type::bf16>;
template class jit_uni_lrn_bwd_kernel_t<avx2, zendnn::impl::data_type::f32>;

template class jit_uni_lrn_kernel_t<
        jit_uni_lrn_bwd_kernel_t<avx2, zendnn::impl::data_type::f32>>;
template class jit_uni_lrn_kernel_t<
        jit_uni_lrn_bwd_kernel_t<avx512_common, zendnn::impl::data_type::f32>>;
template class jit_uni_lrn_kernel_t<
        jit_uni_lrn_bwd_kernel_t<avx512_common, zendnn::impl::data_type::bf16>>;
