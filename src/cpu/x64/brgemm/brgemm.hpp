...
///
status_t ZENDNN_API brgemm_desc_init(brgemm_t *brg, cpu_isa_t isa,
...
///
status_t ZENDNN_API brdgmm_desc_init(brgemm_t *brg, cpu_isa_t isa,
        brgemm_batch_kind_t type, impl::data_type_t dt_a,
...
///
status_t ZENDNN_API brgemm_desc_set_attr(
...
///
status_t ZENDNN_API brgemm_kernel_create(
...
///
void ZENDNN_API brgemm_kernel_destroy(brgemm_kernel_t *brg_kernel);
...
///     avx512 version
///
void ZENDNN_API brgemm_kernel_execute(const brgemm_kernel_t *brg_kernel, int bs,
...
///
status_t ZENDNN_API brgemm_init_tiles(const brgemm_t &brg, char palette[64]);
