...
struct ZENDNN_API brgemm_attr_t {
    brgemm_attr_t();
...
private:
    ...
    ZENDNN_DISALLOW_COPY_AND_ASSIGN(brgemm_kernel_common_t);
};
...
private:
    ...
    ZENDNN_DISALLOW_COPY_AND_ASSIGN(brgemm_amx_uker_t);
};
...
private:
    ...
    ZENDNN_DISALLOW_COPY_AND_ASSIGN(brdgmm_kernel_t);
};
