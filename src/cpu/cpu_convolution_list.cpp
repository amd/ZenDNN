...
const std::map<conv_impl_key_t, std::vector<pd_create_f>> impl_list_map {
    ...
    {   {forward, u8, s8,u8}, {
            ...
            // unsigned int8 input, signed int8  filters, unsigned int8 output (int32 bias accumulation)
    ...
    {   {forward, s8, s8,u8}, {
            // signed int8 input, signed int8  filters , unsigned int8 output (int32 bias accumulation)
    ...
    {   {forward, s8, s8,s8}, {
            // Quantization Support
            // signed int8 input, signed int8  filters , signed int8 output (int32 bias accumulation)
