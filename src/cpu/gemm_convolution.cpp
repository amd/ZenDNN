...
status_t gemm_convolution_fwd_t::execute_forward_nspc(
    ...
    auto src_base = CTX_IN_MEM(const data_t *, ZENDNN_ARG_SRC);
    auto wei_base = CTX_IN_MEM(const data_t *, ZENDNN_ARG_WEIGHTS);
    auto bia_base = CTX_IN_MEM(const data_t *, ZENDNN_ARG_BIAS);
    auto dst_base = CTX_OUT_MEM(data_t *, ZENDNN_ARG_DST);
    ...
    zendnnInfo(ZENDNN_CORELOG, "mb=",jcp.mb, " ih=",jcp.ih, " iw=",jcp.iw,
               ...
               " f_pad=",jcp.f_pad, " is=", jcp.is, " os=",jcp.os, " ks=",jcp.ks,
               " ngroups=",jcp.ngroups," ic=",jcp.ic, " oc=",jcp.oc);
...
status_t gemm_convolution_bwd_data_t::execute_backward_data_nspc(
    ...
    auto diff_dst_base = CTX_IN_MEM(const data_t *, ZENDNN_ARG_DIFF_DST);
    auto wei_base = CTX_IN_MEM(const data_t *, ZENDNN_ARG_WEIGHTS);
    auto bia_base = CTX_IN_MEM(const data_t *, ZENDNN_ARG_BIAS);
    auto diff_src_base = CTX_OUT_MEM(data_t *, ZENDNN_ARG_DIFF_SRC);
