 ...
 *   scaled by -128 * alpha
 *
 * The rest of parameters is described in zendnn.h
 */
zendnn_status_t simple_gemm_s8s8s32(const char *transA, const char *transB,
    ...
    if (*oa != 0 || *ob != 0) return zendnn_unimplemented;
