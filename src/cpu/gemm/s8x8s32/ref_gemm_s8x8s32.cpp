...
zendnn_status_t ref_gemm_s8x8s32(const char *transa, const char *transb,
    ...
    zendnn::impl::parallel_nd(a_cols, a_rows, [&](dim_t j, dim_t i) {
        da_setter(i, j,
    ...
    zendnn::impl::parallel_nd(b_cols, b_rows, [&](dim_t j, dim_t i) {
        db_setter(i, j,
    ...
    zendnn::impl::parallel_nd(n, m, [&](dim_t j, dim_t i) {
...
template zendnn_status_t ref_gemm_s8x8s32<uint8_t>(const char *transa,
...
template zendnn_status_t ref_gemm_s8x8s32<int8_t>(const char *transa,
        const char *transb, const char *offsetc, const dim_t *M, const dim_t *N,
        const dim_t *K, const float *alpha, const int8_t *A, const dim_t *LDA,
