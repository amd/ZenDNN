...
template <typename data_t>
zendnn_status_t ref_gemm(const char *transa_, const char *transb_,
...
template zendnn_status_t ref_gemm<float>(const char *transa_, const char *transb_,
...
template zendnn_status_t ref_gemm<double>(const char *transa_,
