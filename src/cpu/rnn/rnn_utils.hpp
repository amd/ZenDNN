...
#define rnn_gemm_sig(f) \
    zendnn_status_t f(const char transA, const char transB, dim_t m, dim_t n, \
...
bool init_conf(rnn_conf_t &rnn, const rnn_desc_t &rd,
    ...
    switch (rd.direction) {
        ...
        case zendnn_unidirectional_right2left: rnn.exec_dir = r2l; break;
        case zendnn_bidirectional_concat: rnn.exec_dir = bi_concat; break;
        case zendnn_bidirectional_sum: rnn.exec_dir = bi_sum; break;
        default: break;
    }
    ...
    rnn.n_states = rd.cell_kind == zendnn_vanilla_lstm ? 2 : 1;
    ...
    const auto set_pack_sizes
        ...
        for (int p = 0; p < n_parts; p++) {
            ...
            if (st != zendnn_success) return false;
