...
/* The following enum is temporal implementation.
   It should be made in zendnn_types.h,
   but an RFC is requird to modify zendnn_types.h.
   The following values are used with
   static_cast<zendnn_cpu_isa_t>, the same values
   defined in zendnn_cpu_isa_t are temporaly used. */
/// CPU instruction set flags
enum {
    /// AARCH64 Advanced SIMD & floating-point
    zendnn_cpu_isa_asimd = 0x1,
    /// AARCH64 SVE 128 bits
    zendnn_cpu_isa_sve_128 = 0x3,
    /// AARCH64 SVE 256 bits
    zendnn_cpu_isa_sve_256 = 0x7,
    /// AARCH64 SVE 384 bits
    zendnn_cpu_isa_sve_384 = 0xf,
    /// AARCH64 SVE 512 bits
    zendnn_cpu_isa_sve_512 = 0x1f,
};
...
struct cpu_isa_traits<asimd> {
    ...
    static constexpr zendnn_cpu_isa_t user_option_val
            = static_cast<zendnn_cpu_isa_t>(zendnn_cpu_isa_asimd);
...
struct cpu_isa_traits<sve_512> {
    ...
    static constexpr int n_vregs = 32;
    static constexpr zendnn_cpu_isa_t user_option_val
            = static_cast<zendnn_cpu_isa_t>(zendnn_cpu_isa_sve_512);
