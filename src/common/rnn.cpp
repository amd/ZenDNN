...
status_t check_dim_consistency(const rnn_desc_t &r) {
    const bool is_lstm_projection = r.cell_kind == zendnn_vanilla_lstm
    ...
    const dim_t D = one_of(r.direction, zendnn_unidirectional_left2right,
...
status_t rnn_common_fwd_desc_init(zendnn_rnn_desc_t *rnn_desc,
        prop_kind_t prop_kind, zendnn_alg_kind_t cell_kind,
        ...
        zendnn_alg_kind_t activation = zendnn_alg_kind_undef, float alpha = 0.0f,
        float beta = 0.0f) {
    ...
    if (cell_kind == zendnn_vanilla_rnn) {
    ...
    if (cell_kind == zendnn_vanilla_lstm) {
...
status_t rnn_common_bwd_desc_init(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_alg_kind_t cell_kind,
        const zendnn_rnn_direction_t direction,
...
status_t zendnn_vanilla_rnn_forward_desc_init(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, const zendnn_alg_kind_t activation,
        const zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *weights_layer_desc,
...
status_t zendnn_lstm_forward_desc_init(zendnn_rnn_desc_t *rnn_desc,
    ...
    return zendnn_lstm_forward_desc_init_v3(rnn_desc, prop_kind, direction,
...
status_t zendnn_lstm_forward_desc_init_v2(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *src_iter_c_desc,
...
status_t zendnn_lstm_forward_desc_init_v3(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *src_iter_c_desc,
...
status_t zendnn_gru_forward_desc_init(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *weights_layer_desc,
...
status_t zendnn_lbr_gru_forward_desc_init(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *weights_layer_desc,
...
status_t zendnn_vanilla_rnn_backward_desc_init(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, const zendnn_alg_kind_t activation,
        const zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
...
status_t zendnn_lstm_backward_desc_init(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *src_iter_c_desc,
        ...
        const zendnn_memory_desc_t *diff_dst_iter_desc,
        const zendnn_memory_desc_t *diff_dst_iter_c_desc, unsigned flags) {
    return zendnn_lstm_backward_desc_init_v3(rnn_desc, prop_kind, direction,
            src_layer_desc, src_iter_desc, src_iter_c_desc, weights_layer_desc,
            weights_iter_desc, nullptr, nullptr, bias_desc, dst_layer_desc,
...
status_t zendnn_lstm_backward_desc_init_v2(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *src_iter_c_desc,
...
status_t zendnn_lstm_backward_desc_init_v3(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *src_iter_c_desc,
...
status_t zendnn_gru_backward_desc_init(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *weights_layer_desc,
...
status_t zendnn_lbr_gru_backward_desc_init(zendnn_rnn_desc_t *rnn_desc,
        zendnn_prop_kind_t prop_kind, zendnn_rnn_direction_t direction,
        const zendnn_memory_desc_t *src_layer_desc,
        const zendnn_memory_desc_t *src_iter_desc,
        const zendnn_memory_desc_t *weights_layer_desc,
