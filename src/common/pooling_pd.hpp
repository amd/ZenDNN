...
private:
    ...
    pooling_v2_desc_t cast_pool_v1_to_v2(
        ...
        utils::array_copy(
                pool_v2_desc.strides, pool_desc.strides, ZENDNN_MAX_NDIMS);
        utils::array_copy(
                pool_v2_desc.kernel, pool_desc.kernel, ZENDNN_MAX_NDIMS);
        utils::array_copy(
                pool_v2_desc.padding[0], pool_desc.padding[0], ZENDNN_MAX_NDIMS);
        utils::array_copy(
                pool_v2_desc.padding[1], pool_desc.padding[1], ZENDNN_MAX_NDIMS);
        utils::array_copy(
                pool_v2_desc.kernel, pool_desc.kernel, ZENDNN_MAX_NDIMS);
        utils::array_copy(
                pool_v2_desc.kernel, pool_desc.kernel, ZENDNN_MAX_NDIMS);
        utils::array_set(pool_v2_desc.dilation, 0, ZENDNN_MAX_NDIMS);
