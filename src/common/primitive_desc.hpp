...
// zendnn_primitive_desc is a user facing entity that has an alias
...
struct zendnn_primitive_desc : public zendnn::impl::c_compatible {
    ...
    virtual ~zendnn_primitive_desc() = default;

    const char *info() const;
    zendnn::impl::engine_t *engine() const;
    const zendnn::impl::primitive_attr_t *attr() const;
    virtual zendnn::impl::engine_t *scratchpad_engine() const;

    virtual zendnn::impl::engine_t *src_engine() const;
    virtual zendnn::impl::engine_t *dst_engine() const;

    virtual zendnn::impl::status_t query(
