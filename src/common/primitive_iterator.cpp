...
status_t zendnn_primitive_desc_iterator_create(
...
status_t zendnn_primitive_desc_iterator_next(
...
primitive_desc_iface_t *zendnn_primitive_desc_iterator_fetch(
...
status_t zendnn_primitive_desc_clone(
...
status_t zendnn_primitive_desc_iterator_destroy(
        primitive_desc_iterator_t *iterator) {
    delete iterator;
    return success;
}

status_t zendnn_primitive_desc_create(
        primitive_desc_iface_t **primitive_desc_iface,
        const_c_op_desc_t c_op_desc, const primitive_attr_t *attr,
        engine_t *engine, const primitive_desc_iface_t *hint_fwd_pd) {
    primitive_desc_iterator_t *it;
    status_t status = zendnn_primitive_desc_iterator_create(
