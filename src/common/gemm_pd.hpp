...
struct gemm_pd_t : public primitive_desc_t {
    ...
    arg_usage_t arg_usage(int arg) const override {
        if (utils::one_of(arg, ZENDNN_ARG_SRC_0, ZENDNN_ARG_SRC_1))
    ...
    const memory_desc_t *arg_md(int arg) const override {
        switch (arg) {
            case ZENDNN_ARG_SRC_0: return src_md(0);
            case ZENDNN_ARG_SRC_1: return src_md(1);
            case ZENDNN_ARG_BIAS: return src_md(2);
