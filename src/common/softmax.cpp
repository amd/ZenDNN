...
status_t zendnn_softmax_forward_desc_init(softmax_desc_t *softmax_desc,
...
status_t zendnn_softmax_backward_desc_init(softmax_desc_t *softmax_desc,
...
status_t zendnn_logsoftmax_forward_desc_init(logsoftmax_desc_t *logsoftmax_desc,
        prop_kind_t prop_kind, const memory_desc_t *data_desc,
        int logsoftmax_axis) {
    if (!one_of(prop_kind, forward_inference, forward_training))
        return invalid_arguments;
...
status_t zendnn_logsoftmax_backward_desc_init(logsoftmax_desc_t *logsoftmax_desc,
        const memory_desc_t *diff_desc, const memory_desc_t *data_desc,
        int logsoftmax_axis) {
    return softmax_desc_init(logsoftmax_desc, primitive_kind::logsoftmax,
...
status_t zendnn_softmax_v2_forward_desc_init(softmax_v2_desc_t *softmax_v2_desc,
        prop_kind_t prop_kind, alg_kind_t alg_kind,
        const memory_desc_t *src_desc, const memory_desc_t *dst_desc,
        int softmax_axis) {
    if (!one_of(prop_kind, forward_inference, forward_training))
...
status_t zendnn_softmax_v2_backward_desc_init(softmax_v2_desc_t *softmax_v2_desc,
