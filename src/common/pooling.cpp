...
status_t zendnn_pooling_forward_desc_init(pooling_desc_t *pool_desc,
...
status_t zendnn_pooling_backward_desc_init(pooling_desc_t *pool_desc,
...
status_t zendnn_pooling_v2_forward_desc_init(pooling_v2_desc_t *pool_v2_desc,
        prop_kind_t prop_kind, alg_kind_t alg_kind,
        const memory_desc_t *src_desc, const memory_desc_t *dst_desc,
...
status_t zendnn_pooling_v2_backward_desc_init(pooling_v2_desc_t *pool_v2_desc,
        alg_kind_t alg_kind, const memory_desc_t *diff_src_desc,
        const memory_desc_t *diff_dst_desc, const dims_t strides,
        const dims_t kernel, const dims_t dilation, const dims_t padding_l,
        const dims_t padding_r) {
