...
const std::shared_ptr<primitive_desc_t> &zendnn_primitive_desc::impl() const {
    return pd_;
}

zendnn::impl::engine_t *zendnn_primitive_desc::engine() const {
    return engine_;
}
const zendnn::impl::primitive_attr_t *zendnn_primitive_desc::attr() const {
    return pd_->attr();
}

const char *zendnn_primitive_desc::info() const {
    return pd_->info(engine_);
}

zendnn::impl::engine_t *zendnn_primitive_desc::src_engine() const {
    return engine_;
}
zendnn::impl::engine_t *zendnn_primitive_desc::dst_engine() const {
    return engine_;
}

zendnn::impl::engine_t *zendnn_primitive_desc::scratchpad_engine() const {
    return engine_;
}
...
status_t zendnn_primitive_desc_get_attr(
