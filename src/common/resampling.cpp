...
status_t zendnn_resampling_forward_desc_init(resampling_desc_t *resampling_desc,
        prop_kind_t prop_kind, alg_kind_t alg_kind, const float *factors,
        const memory_desc_t *src_desc, const memory_desc_t *dst_desc) {
...
status_t zendnn_resampling_backward_desc_init(resampling_desc_t *resampling_desc,
