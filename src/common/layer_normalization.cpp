...
status_t lnorm_desc_init(layer_normalization_desc_t *lnorm_desc,
    ...
    if (stat_desc)
        ...
        CHECK(zendnn_memory_desc_init_by_tag(&ld.stat_desc,
...
status_t zendnn_layer_normalization_forward_desc_init(
...
status_t zendnn_layer_normalization_backward_desc_init(
        layer_normalization_desc_t *lnorm_desc, prop_kind_t prop_kind,
