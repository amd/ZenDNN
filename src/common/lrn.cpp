...
status_t zendnn_lrn_forward_desc_init(lrn_desc_t *lrn_desc, prop_kind_t prop_kind,
...
status_t zendnn_lrn_backward_desc_init(lrn_desc_t *lrn_desc, alg_kind_t alg_kind,
