...
status_t zendnn_inner_product_forward_desc_init(inner_product_desc_t *ip_desc,
...
status_t zendnn_inner_product_backward_data_desc_init(
...
status_t zendnn_inner_product_backward_weights_desc_init(
