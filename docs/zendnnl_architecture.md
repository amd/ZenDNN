...
| **Normalization** | LayerNorm, RMSNorm, FusedAddRMSNorm, FusedLayerNormAdd, and BatchNorm via a single direct entry point; AVX-512 / AVX-512-FP16 vectorized kernels. | [lowoha_normalization_operator.md](operator/low_overhead_operator/lowoha_normalization_operator.md) |
