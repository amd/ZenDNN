...
post_op_t::post_op_t(post_op_type_t type_)
    ...
    switch (type_) {
        case post_op_type_t::elu: elu_params.alpha = 1.0; break;
        case post_op_type_t::leaky_relu: leaky_relu_params.nslope = 0.0; break;
        case post_op_type_t::swish: swish_params.scale = 1.0; break;
...
std::string post_op_t::post_op_info(post_op_t post_op) {
    switch (post_op.type) {
        case post_op_type_t::relu: return std::string("relu"); break;
        case post_op_type_t::leaky_relu:
            return std::string("leaky_relu");
            break;
        case post_op_type_t::gelu_tanh: return std::string("gelu_tanh"); break;
        case post_op_type_t::gelu_erf: return std::string("gelu_erf"); break;
        case post_op_type_t::tanh: return std::string("tanh"); break;
        case post_op_type_t::swish: return std::string("swish"); break;
        case post_op_type_t::sigmoid: return std::string("sigmoid"); break;
        case post_op_type_t::clip: return std::string("clip"); break;
        case post_op_type_t::binary_add:
        ...
        case post_op_type_t::binary_mul:
            ...
            break;
        case post_op_type_t::mish: return std::string("mish"); break;
