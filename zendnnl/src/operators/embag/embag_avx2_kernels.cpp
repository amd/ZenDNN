...
#include "embag_fp32_avx2_utils.hpp"
...
status_t embag_f32_avx2_kernel_t::execute(const context_type& context_,
  ...
  log_error("embag_fp32_avx2_kernel_t for this case is unimplemented");
...
status_t embag_bf16_avx2_kernel_t::execute(const context_type& context_,
  ...
  log_info("embag_bf16_avx2_kernel_t is unimplemented");
