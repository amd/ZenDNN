...
status_t embag_ref_kernel_t::execute(const context_type &context_,
    ...
    if (table_dtype == data_type_t::f32 && dst_dtype == data_type_t::f32) {
        ...
        if (indices_data_type == data_type_t::s64) {
            ...
            embag_ref_kernel<float, int64_t, int64_t, float>(input_f32, weights,
                    indices, offsets, dst_f32, width, indsz, offsz, padidx,
            ...
            embag_ref_kernel<float, int32_t, int32_t, float>(input_f32, weights,
                    indices, offsets, dst_f32, width, indsz, offsz, padidx,
                    is_weights, algo, stride, include_last_offset);
        } else {
        ...
        if (indices_data_type == data_type_t::s64) {
            ...
            embag_ref_kernel<float, int64_t, int64_t, bfloat16_t>(input_f32,
                    weights, indices, offsets, dst_bf16, width, indsz, offsz,
        ...
        if (indices_data_type == data_type_t::s64) {
            ...
            embag_ref_kernel<uint16_t, int64_t, int64_t, float>(input_bf16,
                    weights, indices, offsets, dst_f32, width, indsz, offsz,
                    padidx, is_weights, algo, stride, include_last_offset);
        } else if (indices_data_type == data_type_t::s32) {
            int32_t *indices
                    = (int32_t *)indices_tensor.get_raw_handle_unsafe();
        ...
        if (indices_data_type == data_type_t::s64) {
            ...
            embag_ref_kernel<float16_t, int64_t, int64_t, float16_t>(input_f16,
                    weights, indices, offsets, dst_f16, width, indsz, offsz,
                    padidx, is_weights, algo, stride, include_last_offset);
        } else if (indices_data_type == data_type_t::s32) {
            int32_t *indices
                    = (int32_t *)indices_tensor.get_raw_handle_unsafe();
    ...
    if (table_dtype == data_type_t::s8 && dst_dtype == data_type_t::f32) {
        ...
        if (indices_data_type == data_type_t::s64) {
            ...
            embag_int8_int4_ref_kernel<false, int8_t, int64_t, int64_t, float>(
                    input_s8, weights, indices, offsets, dst_f32, width, indsz,
        ...
        if (indices_data_type == data_type_t::s64) {
            ...
            embag_int8_int4_ref_kernel<false, int8_t, int64_t, int64_t,
                    bfloat16_t>(input_s8, weights, indices, offsets, dst_bf16,
        ...
        if (indices_data_type == data_type_t::s64) {
            ...
            embag_int8_int4_ref_kernel<true, uint8_t, int64_t, int64_t, float>(
                    input_s4, weights, indices, offsets, dst_f32, width, indsz,
                    offsz, padidx, is_weights, algo, stride,
                    include_last_offset, table_dtype, fp16_scale_bias);
        } else if (indices_data_type == data_type_t::s32) {
            int32_t *indices
        ...
        if (indices_data_type == data_type_t::s64) {
            ...
            embag_int8_int4_ref_kernel<true, uint8_t, int64_t, int64_t,
                    bfloat16_t>(input_s4, weights, indices, offsets, dst_bf16,
                    width, indsz, offsz, padidx, is_weights, algo, stride,
                    include_last_offset, table_dtype, fp16_scale_bias);
        } else if (indices_data_type == data_type_t::s32) {
            int32_t *indices
...
template void embag_ref_kernel<float, int64_t, int64_t, float>(const float *,
        const float *, const int64_t *, const int64_t *, float *, int64_t,
        int64_t, int64_t, int64_t, bool, embag_algo_t, int64_t, bool);

template void embag_ref_kernel<float, int32_t, int32_t, float>(const float *,
        const float *, const int32_t *, const int32_t *, float *, int64_t,
        int64_t, int64_t, int64_t, bool, embag_algo_t, int64_t, bool);

template void embag_ref_kernel<float, int64_t, int64_t, bfloat16_t>(
        const float *, const float *, const int64_t *, const int64_t *,
        bfloat16_t *, int64_t, int64_t, int64_t, int64_t, bool, embag_algo_t,
        int64_t, bool);

template void embag_ref_kernel<float, int32_t, int32_t, bfloat16_t>(
        const float *, const float *, const int32_t *, const int32_t *,
        bfloat16_t *, int64_t, int64_t, int64_t, int64_t, bool, embag_algo_t,
        int64_t, bool);

template void embag_ref_kernel<uint16_t, int64_t, int64_t, bfloat16_t>(
        const uint16_t *, const float *, const int64_t *, const int64_t *,
        bfloat16_t *, int64_t, int64_t, int64_t, int64_t, bool, embag_algo_t,
        int64_t, bool);

template void embag_ref_kernel<uint16_t, int32_t, int32_t, bfloat16_t>(
