...
#ifndef MATMUL_AI_LOOPER_BF16_GEMM_LOOPER_HPP
#define MATMUL_AI_LOOPER_BF16_GEMM_LOOPER_HPP
...
/// BF16 GEMM entry point (restructured).
///
/// Owns: planning (via bf16_gemm_plan), weight caching, buffer management,
///       OMP parallel regions, MC/NC/KC tile loops, packing orchestration.
...
#endif // MATMUL_AI_LOOPER_BF16_GEMM_LOOPER_HPP
