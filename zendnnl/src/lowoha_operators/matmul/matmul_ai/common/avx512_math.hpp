...
#ifndef MATMUL_AI_INTRINSIC_AVX512_MATH_HPP
#define MATMUL_AI_INTRINSIC_AVX512_MATH_HPP
...
static inline __m512 apply_fused_postop(__m512 v, fused_postop_t op) {
  ...
  case fused_postop_t::swish:
    // swish with alpha=1 (beta stored elsewhere if needed)
...
#endif // MATMUL_AI_INTRINSIC_AVX512_MATH_HPP
