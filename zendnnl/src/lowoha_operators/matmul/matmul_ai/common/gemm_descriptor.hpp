...
#ifndef MATMUL_AI_GEMM_DESCRIPTOR_HPP
#define MATMUL_AI_GEMM_DESCRIPTOR_HPP
...
/// Canonical description of a GEMM problem for AI kernel dispatch.
...
#endif // MATMUL_AI_GEMM_DESCRIPTOR_HPP
