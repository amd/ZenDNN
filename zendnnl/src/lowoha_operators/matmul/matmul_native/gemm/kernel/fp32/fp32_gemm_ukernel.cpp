...
void avx512_ukernel_6x64_asm(const float *__restrict pa, int a_stride,
    ...
    __asm__ __volatile__(
            ...
            [a4] "+r"(a4), [a5] "+r"(a5), [bp] "+r"(bp), [k2] "+r"(k2)
            : [bs] "r"(bs), [ca] "r"(c_acc)
    ...
    if (k & 1) {
        ...
        c03 = _mm512_fmadd_ps(a, b3, c03);
        a = _mm512_set1_ps(*a1);
        c10 = _mm512_fmadd_ps(a, b0, c10);
        c11 = _mm512_fmadd_ps(a, b1, c11);
        c12 = _mm512_fmadd_ps(a, b2, c12);
        c13 = _mm512_fmadd_ps(a, b3, c13);
        a = _mm512_set1_ps(*a2);
        c20 = _mm512_fmadd_ps(a, b0, c20);
        c21 = _mm512_fmadd_ps(a, b1, c21);
        c22 = _mm512_fmadd_ps(a, b2, c22);
        c23 = _mm512_fmadd_ps(a, b3, c23);
        a = _mm512_set1_ps(*a3);
        c30 = _mm512_fmadd_ps(a, b0, c30);
        c31 = _mm512_fmadd_ps(a, b1, c31);
        c32 = _mm512_fmadd_ps(a, b2, c32);
        c33 = _mm512_fmadd_ps(a, b3, c33);
        a = _mm512_set1_ps(*a4);
        c40 = _mm512_fmadd_ps(a, b0, c40);
        c41 = _mm512_fmadd_ps(a, b1, c41);
        c42 = _mm512_fmadd_ps(a, b2, c42);
        c43 = _mm512_fmadd_ps(a, b3, c43);
        a = _mm512_set1_ps(*a5);
        c50 = _mm512_fmadd_ps(a, b0, c50);
        c51 = _mm512_fmadd_ps(a, b1, c51);
        c52 = _mm512_fmadd_ps(a, b2, c52);
        c53 = _mm512_fmadd_ps(a, b3, c53);
    }

    // ── Epilogue ──
    if (beta != 0.0f) {
        __m512 bv = _mm512_set1_ps(beta);
        c00 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C), c00);
        c01 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 16), c01);
        c02 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 32), c02);
        c03 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 48), c03);
        c10 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + ldc), c10);
        c11 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + ldc + 16), c11);
        c12 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + ldc + 32), c12);
        c13 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + ldc + 48), c13);
        c20 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 2 * ldc), c20);
        c21 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 2 * ldc + 16), c21);
        c22 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 2 * ldc + 32), c22);
        c23 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 2 * ldc + 48), c23);
        c30 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 3 * ldc), c30);
        c31 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 3 * ldc + 16), c31);
        c32 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 3 * ldc + 32), c32);
        c33 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 3 * ldc + 48), c33);
        c40 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 4 * ldc), c40);
        c41 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 4 * ldc + 16), c41);
        c42 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 4 * ldc + 32), c42);
        c43 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 4 * ldc + 48), c43);
        c50 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 5 * ldc), c50);
        c51 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 5 * ldc + 16), c51);
        c52 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 5 * ldc + 32), c52);
        c53 = _mm512_fmadd_ps(bv, _mm512_loadu_ps(C + 5 * ldc + 48), c53);
    }
    if (bias) {
        __m512 bv0 = _mm512_loadu_ps(bias), bv1 = _mm512_loadu_ps(bias + 16),
               bv2 = _mm512_loadu_ps(bias + 32),
               bv3 = _mm512_loadu_ps(bias + 48);
        c00 = _mm512_add_ps(c00, bv0);
        c01 = _mm512_add_ps(c01, bv1);
        c02 = _mm512_add_ps(c02, bv2);
        c03 = _mm512_add_ps(c03, bv3);
        c10 = _mm512_add_ps(c10, bv0);
        c11 = _mm512_add_ps(c11, bv1);
        c12 = _mm512_add_ps(c12, bv2);
        c13 = _mm512_add_ps(c13, bv3);
        c20 = _mm512_add_ps(c20, bv0);
        c21 = _mm512_add_ps(c21, bv1);
        c22 = _mm512_add_ps(c22, bv2);
        c23 = _mm512_add_ps(c23, bv3);
        c30 = _mm512_add_ps(c30, bv0);
        c31 = _mm512_add_ps(c31, bv1);
        c32 = _mm512_add_ps(c32, bv2);
        c33 = _mm512_add_ps(c33, bv3);
        c40 = _mm512_add_ps(c40, bv0);
        c41 = _mm512_add_ps(c41, bv1);
        c42 = _mm512_add_ps(c42, bv2);
        c43 = _mm512_add_ps(c43, bv3);
        c50 = _mm512_add_ps(c50, bv0);
        c51 = _mm512_add_ps(c51, bv1);
        c52 = _mm512_add_ps(c52, bv2);
        c53 = _mm512_add_ps(c53, bv3);
    }
    if (fused_op != fused_postop_t::none) {
        c00 = apply_fused_postop(c00, fused_op);
        c01 = apply_fused_postop(c01, fused_op);
        c02 = apply_fused_postop(c02, fused_op);
        c03 = apply_fused_postop(c03, fused_op);
        c10 = apply_fused_postop(c10, fused_op);
        c11 = apply_fused_postop(c11, fused_op);
        c12 = apply_fused_postop(c12, fused_op);
        c13 = apply_fused_postop(c13, fused_op);
        c20 = apply_fused_postop(c20, fused_op);
        c21 = apply_fused_postop(c21, fused_op);
        c22 = apply_fused_postop(c22, fused_op);
        c23 = apply_fused_postop(c23, fused_op);
        c30 = apply_fused_postop(c30, fused_op);
        c31 = apply_fused_postop(c31, fused_op);
        c32 = apply_fused_postop(c32, fused_op);
        c33 = apply_fused_postop(c33, fused_op);
        c40 = apply_fused_postop(c40, fused_op);
        c41 = apply_fused_postop(c41, fused_op);
        c42 = apply_fused_postop(c42, fused_op);
        c43 = apply_fused_postop(c43, fused_op);
        c50 = apply_fused_postop(c50, fused_op);
        c51 = apply_fused_postop(c51, fused_op);
        c52 = apply_fused_postop(c52, fused_op);
        c53 = apply_fused_postop(c53, fused_op);
    }
...
// ============================================================================
template void avx512_ukernel<6, 4>(const float *, int, const float *, int,
        float *, int, int, float, const float *, fused_postop_t);
template void avx512_ukernel<6, 2>(const float *, int, const float *, int,
        float *, int, int, float, const float *, fused_postop_t);
template void avx512_ukernel<6, 1>(const float *, int, const float *, int,
        float *, int, int, float, const float *, fused_postop_t);
...
void avx512_tail_kernel(const float *__restrict pa, int a_stride,
    ...
    for (int kk = 0; kk < k; ++kk) {
        ...
        for (int m = 0; m < mr_count; ++m) {
            ...
            if (rem)
                acc[m][full_vecs]
                        = _mm512_fmadd_ps(a, bv[full_vecs], acc[m][full_vecs]);
        }
    }
        ...
        for (int m = 0; m < mr_count; ++m) {
            for (int v = 0; v < full_vecs; ++v)
                acc[m][v] = _mm512_fmadd_ps(
                        bv, _mm512_loadu_ps(C + m * ldc + v * 16), acc[m][v]);
            if (rem)
                acc[m][full_vecs] = _mm512_fmadd_ps(bv,
...
// ============================================================================
void scalar_microkernel(const float *pa, int a_stride, const float *pb,
