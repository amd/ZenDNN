...
/// Best-of-3 selector for BF16 GEMV (M=1, single-thread).
/// Returns the optimal algo (native_gemm, native_brgemm, or aocl_dlp_blocked)
/// for a given shape based on empirical benchmarks on AMD Zen 5.
