...
# Retains existing functionality of _ZENDNN_USE_MKL
if(_ZENDNN_USE_MKL)
    set(ZENDNN_BLAS_VENDOR "MKL")
endif()

if(ZENDNN_BLAS_VENDOR STREQUAL "NONE")
    return()
endif()

if (NOT "${ZENDNN_BLAS_VENDOR}" MATCHES "^(NONE|MKL|OPENBLAS|ARMPL|ANY)$")
    message(FATAL_ERROR "Unsupported ZENDNN_BLAS_VENDOR: ${ZENDNN_BLAS_VENDOR}.")
endif()

macro(expect_arch_or_generic arch)
    if(NOT "${ZENDNN_TARGET_ARCH}" MATCHES "^(${arch}|ARCH_GENERIC)$")
        message(FATAL_ERROR "ZENDNN_BLAS_VENDOR=${ZENDNN_BLAS_VENDOR} is not supported "
            "for ZENDNN_TARGET_ARCH=${ZENDNN_TARGET_ARCH}.")
        return()
    endif()
endmacro()

# Check chosen ZENDNN_BLAS_VENDOR is supported and set BLA_VENDOR accordingly
set(CBLAS_HEADERS "cblas.h")
if(ZENDNN_BLAS_VENDOR STREQUAL "MKL")
    expect_arch_or_generic("X64")
    set(BLA_VENDOR "Intel10_64_dyn")
    set(CBLAS_HEADERS "mkl_cblas.h")
elseif(ZENDNN_BLAS_VENDOR STREQUAL "OPENBLAS")
    set(BLA_VENDOR "OpenBLAS")
elseif(ZENDNN_BLAS_VENDOR STREQUAL "ARMPL")
    set(CBLAS_HEADERS "armpl.h")
    expect_arch_or_generic("AARCH64")
    if(ZENDNN_CPU_RUNTIME STREQUAL "OMP")
