...
macro(handle_tbb_target)
    if(TBB_FOUND)
        ...
        unset(_tbb_root)
    elseif(ZENDNN_CPU_RUNTIME STREQUAL "NONE")
        message(FATAL_ERROR "For GPU only SYCL configuration TBB is required for testing.")
    else()
        message(FATAL_ERROR "ZENDNN_CPU_THREADING_RUNTIME is ${ZENDNN_CPU_THREADING_RUNTIME} but TBB is not found.")
    endif()
...
if(NOT ZENDNN_CPU_THREADING_RUNTIME STREQUAL "TBB")
    return()
endif()
