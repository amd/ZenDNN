...
if (ZENDNN_LIBM_ENABLE)
    set(LIBM_ENABLE TRUE)
    #add_definitions_with_host_compiler(-DBLIS_EXPERT=1)
endif()
...
if (ZENDNN_USE_LOCAL_BLIS)
    ...
    elseif(WIN32)
        ...
        message(STATUS ${BLIS_PATH_WIN} , $ENV{ZENDNN_BLIS_PATH})
...
if (ZENDNN_USE_LOCAL_LIBM)
    set(LIBM_PATH $ENV{ZENDNN_LIBM_PATH})
    if(UNIX)
        include_directories_with_host_compiler(${LIBM_PATH}/include)
        list(APPEND EXTRA_SHARED_LIBS ${LIBM_PATH}/lib/libalm.so)
    endif()
endif()
