...
if(ZENDNN_DPCPP_HOST_COMPILER MATCHES "g\\+\\+")
    if(WIN32)
        message(FATAL_ERROR "${ZENDNN_DPCPP_HOST_COMPILER} cannot be used on Windows")
    endif()
    ...
    if(ZENDNN_TARGET_ARCH STREQUAL "X64")
        if(ZENDNN_ARCH_OPT_FLAGS STREQUAL "HostOpts")
            ...
            append(DPCPP_HOST_COMPILER_OPTS ${ZENDNN_ARCH_OPT_FLAGS})
        endif()
    else()
        message(FATAL_ERROR "The ZENDNN_DPCPP_HOST_COMPILER option is only supported for ZENDNN_TARGET_ARCH=X64")
    endif()
    ...
    find_program(GNU_COMPILER NAMES ${ZENDNN_DPCPP_HOST_COMPILER})
    if(NOT GNU_COMPILER)
...
elseif(NOT ZENDNN_DPCPP_HOST_COMPILER STREQUAL "DEFAULT")
    message(FATAL_ERROR "The valid values for ZENDNN_DPCPP_HOST_COMPILER: DEFAULT and g++ or absolute path to it")
endif()
