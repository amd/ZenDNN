...
if("${ZENDNN_CPU_THREADING_RUNTIME}" STREQUAL "THREADPOOL")
    if("${_ZENDNN_TEST_THREADPOOL_IMPL}" STREQUAL "TBB")
    ...
    if("${_ZENDNN_TEST_THREADPOOL_IMPL}" STREQUAL "EIGEN")
    ...
    if("${_ZENDNN_TEST_THREADPOOL_IMPL}" STREQUAL "STANDALONE")
        message(STATUS "Threadpool testing: standalone")
    endif()

    add_definitions(-DZENDNN_TEST_THREADPOOL_USE_${_ZENDNN_TEST_THREADPOOL_IMPL})
endif()
