...
if(DOXYGEN_FOUND)
    ...
    file(GLOB_RECURSE HEADERS
        ${PROJECT_SOURCE_DIR}/inc/oneapi/zendnn/*.h
        ${PROJECT_SOURCE_DIR}/inc/oneapi/zendnn/*.hpp
        )
    ...
    if(NOT ZENDNN_INSTALL_MODE STREQUAL "BUNDLE")
        install(
            DIRECTORY ${DOXYGEN_OUTPUT_DIR}
            DESTINATION share/doc/${ZENDNN_LIBRARY_NAME} OPTIONAL)
    endif()
endif(DOXYGEN_FOUND)
