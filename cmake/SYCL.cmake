...
if(NOT ZENDNN_WITH_SYCL)
    if (NOT ZENDNN_DPCPP_HOST_COMPILER STREQUAL "DEFAULT")
        message(FATAL_ERROR "ZENDNN_DPCPP_HOST_COMPILER is supported only for DPCPP runtime")
    endif()
    return()
endif()
...
if(NOT ZENDNN_DPCPP_HOST_COMPILER STREQUAL "DEFAULT" AND ZENDNN_SYCL_CUDA)
    message(FATAL_ERROR "ZENDNN_DPCPP_HOST_COMPILER options is not supported for NVIDIA.")
endif()
...
if(LevelZero_FOUND)
    set(ZENDNN_WITH_LEVEL_ZERO TRUE)
