...
if(NOT ZENDNN_TARGET_ARCH STREQUAL "AARCH64")
    return()
endif()

if(NOT ZENDNN_AARCH64_USE_ACL)
    return()
endif()
...
if(ACL_FOUND)
    ...
    if ("${ACL_VERSION_FILE}" STREQUAL "")
        ...
        if (${ACL_VERSION} VERSION_EQUAL "0.0")
            # Unreleased ACL versions come with version string "v0.0-unreleased", and may not be compatible with ZENDNN.
    ...
    add_definitions(-DZENDNN_AARCH64_USE_ACL)
