...
set(BUILD_${ZENDNN_ENABLE_WORKLOAD} TRUE)
message(STATUS "Enabled workload: ${ZENDNN_ENABLE_WORKLOAD}")

if(ZENDNN_ENABLE_PRIMITIVE STREQUAL "ALL")
    set(BUILD_PRIMITIVE_ALL TRUE)
else()
    foreach(impl ${ZENDNN_ENABLE_PRIMITIVE})
...
message(STATUS "Enabled primitives: ${ZENDNN_ENABLE_PRIMITIVE}")

if (ZENDNN_ENABLE_PRIMITIVE_CPU_ISA STREQUAL "ALL")
    set(BUILD_PRIMITIVE_CPU_ISA_ALL TRUE)
else()
    foreach(isa ${ZENDNN_ENABLE_PRIMITIVE_CPU_ISA})
...
message(STATUS "Enabled primitive CPU ISA: ${ZENDNN_ENABLE_PRIMITIVE_CPU_ISA}")

if (ZENDNN_ENABLE_PRIMITIVE_GPU_ISA STREQUAL "ALL")
    set(BUILD_PRIMITIVE_GPU_ISA_ALL TRUE)
else()
    foreach(isa ${ZENDNN_ENABLE_PRIMITIVE_GPU_ISA})
        string(TOUPPER ${isa} uisa)
...
message(STATUS "Enabled primitive GPU ISA: ${ZENDNN_ENABLE_PRIMITIVE_GPU_ISA}")
...
# such cases.
if (NOT ZENDNN_ENABLE_PRIMITIVE STREQUAL "ALL" OR
        NOT ZENDNN_ENABLE_PRIMITIVE_CPU_ISA STREQUAL "ALL" OR
        NOT ZENDNN_ENABLE_PRIMITIVE_GPU_ISA STREQUAL "ALL")
