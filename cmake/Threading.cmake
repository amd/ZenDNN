...
if(ZENDNN_CPU_RUNTIME STREQUAL "NONE")
    set(ZENDNN_CPU_THREADING_RUNTIME "SEQ")
elseif(ZENDNN_CPU_SYCL)
    set(ZENDNN_CPU_THREADING_RUNTIME "TBB")
else()
    set(ZENDNN_CPU_THREADING_RUNTIME "${ZENDNN_CPU_RUNTIME}")
endif()
            ...
            if(EXISTS ${_tbb_ver_header_full_path})
                ...
                if (${TBB_INTERFACE_VERSION} VERSION_LESS 9100)
                    if("${mode}" STREQUAL REQUIRED)
                        message(FATAL_ERROR
                            "ZENDNN requires TBB version 2017 or above")
                    endif()
                    unset(TBB_FOUND)
                else()
                    break()
