...
list(APPEND ZL_CMAKE_ARGS "-DZENDNNL_FBGEMM_INJECTED=${ZENDNNL_FBGEMM_INJECTED}")
list(APPEND ZL_CMAKE_ARGS "-DZENDNNL_FWK_BUILD=${ZENDNNL_FWK_BUILD}")
...
list(APPEND ZL_CMAKE_ARGS "-DZENDNNL_NATIVE_F32_ACCUM=${ZENDNNL_NATIVE_F32_ACCUM}")
list(APPEND ZL_CMAKE_ARGS "-DZENDNNL_FUSED_ADD_RMS_F16=${ZENDNNL_FUSED_ADD_RMS_F16}")
